      ...
      return [
        ...
        function ($log) {
          ...
          methodNames.forEach(function (methodName) {
            DelegateInstance.prototype[methodName] =
              instanceMethodCaller(methodName);
          });
...
*/
      ...
      __repositionScrollbars: function () {
        ...
        if (self.__indicatorX) {
          ...
          if (self.__indicatorX.transformProp !== translate3dX) {
            self.__indicatorX.indicator.style[self.__transformProperty] =
              translate3dX;
        ...
        if (self.__indicatorY) {
          ...
          if (self.__indicatorY.transformProp !== translate3dY) {
            self.__indicatorY.indicator.style[self.__transformProperty] =
              translate3dY;
  ...
  */
      ...
      zoomTo: function (level, animate, originLeft, originTop) {
        ...
        var top =
          ((originTop + self.__scrollTop) * level) / oldLevel - originTop;
        ...
        if (options.startY >= 0 || options.startX >= 0) {
          ionic.requestAnimationFrame(function () {
            self.__originalContainerHeight =
              self.el.getBoundingClientRect().height;
