      ...
      (e.views.Scroll = e.views.View.inherit({
        ...
        __resizeScrollbars: function () {
          ...
          if (t.__indicatorX) {
            var n = Math.max(
              Math.round(
                (t.__clientWidth * t.__clientWidth) / t.__contentWidth
              ),
              20
            );
                  ...
                  setTranslate: function () {
                    ...
                    for (var i = 0; i < y.slides.length; i++) {
                      ...
                      i % 4 === 0
                        ...
                        : (i - 3) % 4 === 0 &&
                          ((c = -y.size), (u = 3 * y.size + 4 * y.size * o)),
                        y.rtl && (c = -c),
                        s() || ((d = c), (c = 0));
                      var p =
                        "rotateX(" +
                ...
                if ((S && S(), o.cancel(k), y)) {
                  if (
                    ...
                    for (a = 0; a < d.stack.length; a++)
                      d.stack[a].viewId === z
                        ? ((d.stack[a].index = 0),
                          (d.stack[a].backViewId = d.stack[a].forwardViewId =
                            null))
              ...
              w &&
                ...
                e &&
                  ...
                  h.backButtonText !== o.backButton.text() &&
                    ((e = a(l + " .back-text")),
                    e &&
                      (e.textContent = h.backButtonText =
                        o.backButton.text()))));
          }),
