    ...
    function (
      ...
      function showPopup(options) {
        ...
        if (popupStack.length > 0) {
          ...
          $ionicPopup._backButtonActionDone =
            $ionicPlatform.registerBackButtonAction(
              onHardwareBackButton,
        ...
        create: function (
          ...
          var switcher = {
            ...
            transition: function (direction, enableBack, allowAnimate) {
              ...
              enteringData.transitionId = leavingData.transitionId =
                transitionId;
              ...
              function transitionComplete() {
                ...
                if (transitionId === transitionCounter) {
                  $q.all(transitionPromises).then(
                    ionicViewSwitcher.transitionEnd
                  );
        ...
        if (isBackEnabled) {
          ...
          if (ele) {
            ...
            if (self.backButtonText !== $ionicConfig.backButton.text()) {
              ...
              if (ele) {
                ele.textContent = self.backButtonText =
        ...
        if ($ionicConfig.backButton.previousTitleText()) {
          ...
          if (previousTitleEle) {
            ...
            if (newPreviousTitleText !== previousTitleText) {
              previousTitleText = previousTitleEle.innerHTML =
 ...
 */
  ...
  IonicModule.controller("$ionicNavBar", [
    ...
    function (
      ...
      var ITEM_TYPES =
        "primaryButtons secondaryButtons leftButtons rightButtons title".split(
          " "
        );
  ...
  */
  ...
  IonicModule.controller("$ionicView", [
    ...
    function ($scope, $element, $attrs, $compile, $rootScope) {
      ...
      var deregIonNavBarInit = $scope.$on(
        "ionNavBar.init",
        function (ev, delegateHandle) {
  ...
  function RepeatManagerFactory($rootScope, $window, $$rAF) {
    ...
    return function RepeatController(options) {
      ...
      this.refreshLayout = function () {
        ...
        containerNode.style[ionic.CSS.TRANSFORM] =
      ...
      function render(forceRerender) {
        ...
        if (renderEndIndex === data.length - 1) {
          ...
          afterItemsNode.style[ionic.CSS.TRANSFORM] =
            TRANSLATE_TEMPLATE_STR.replace(
              PRIMARY,
    ...
    function ($timeout) {
      return {
        ...
        link: function ($scope, $element, $attrs, ctrls) {
          ...
          var jsScrolling = (infiniteScrollCtrl.jsScrolling =
            !scrollCtrl.isNative());
