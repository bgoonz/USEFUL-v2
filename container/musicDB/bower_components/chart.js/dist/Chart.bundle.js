					...
					(function (global, factory) {
						...
						addParseToken(
							...
							function (input, array, config, token) {
								...
								if (month != null) {
									...
									getParsingFlags(config).invalidMonth =
										input;
								}
							}
						);
						...
						function configFromStringAndArray(config) {
							...
							for (i = 0; i < config._f.length; i++) {
								...
								getParsingFlags(tempConfig).score =
									currentScore;
					...
					module.exports = function (Chart) {
						...
						Chart.controllers.bar = Chart.DatasetController.extend({
							...
							getRuler: function () {
								...
								var tickWidth =
									xScale.width / xScale.ticks.length;
								var categoryWidth =
									tickWidth *
							...
							draw: function (ease) {
								...
								Chart.canvasHelpers.unclipArea(
									me.chart.chart.ctx
								);
							},
							...
							Chart.controllers.bar.extend({
								...
								updateElement: function (
									...
									rectangle._model = {
										x: reset
											? scaleBase
											: me.calculateBarX(index, me.index),
										y: me.calculateBarY(
											index,
											me.index,
											ruler
								...
								getRuler: function () {
									...
									var tickHeight =
										yScale.height / yScale.ticks.length;
									var categoryHeight =
										tickHeight *
					...
					module.exports = function (Chart) {
						...
						Chart.animationService = {
							...
							addAnimation: function (
								...
								for (
									var index = 0;
									index < me.animations.length;
									++index
								) {
									if (
										me.animations[index].chartInstance ===
										chartInstance
									) {
						...
						helpers.extend(
							...
							/** @lends Chart.Controller.prototype */ {
								...
								getElementAtEvent: function (e) {
									return Chart.Interaction.modes.single(
										this,
										e
									);
								},
								...
								getElementsAtEvent: function (e) {
									return Chart.Interaction.modes.label(
										this,
										e,
										{ intersect: true }
									);
								...
								getElementsAtXAxis: function (e) {
									return Chart.Interaction.modes["x-axis"](
										this,
										e,
										{ intersect: true }
									);
								...
								getDatasetAtEvent: function (e) {
									return Chart.Interaction.modes.dataset(
										this,
										e,
										{ intersect: true }
									);
			...
			26: [
				function (require, module, exports) {
					...
					module.exports = function (Chart) {
						...
						helpers.getValueOrDefault = function (
							value,
							defaultValue
						) {
						...
						var easingEffects = (helpers.easingEffects = {
							...
							easeInOutBounce: function (t) {
								...
								return (
									easingEffects.easeOutBounce(t * 2 - 1) *
										0.5 +
									1 * 0.5
								);
							},
				...
				function (require, module, exports) {
					...
					module.exports = function () {
						...
						var Chart = function (item, config) {
							this.controller = new Chart.Controller(
								item,
								config,
								this
							);
						...
						Chart.layoutService = {
							...
							update: function (chartInstance, width, height) {
								...
								var chartAreaBoxes = helpers.where(
									...
									function (box) {
										return (
											box.options.position === "chartArea"
										);
									}
								);
					...
					module.exports = function (Chart) {
						...
						Chart.Legend = Chart.Element.extend({
							...
							buildLabels: function () {
								...
								var legendItems = labelOpts.generateLabels.call(
									me,
									me.chart
								);
						...
						Chart.Scale = Chart.Element.extend({
							...
							fit: function () {
								...
								if (tickOpts.display && display) {
									...
									var tallestLabelHeightInLines =
										helpers.numberOfLabelLines(me.ticks);
							...
							draw: function (chartArea) {
								...
								if (isHorizontal) {
									...
									if (
										maxTicks &&
										me.ticks.length > maxTicks
									) {
										while (
											!skipRatio ||
											me.ticks.length / (skipRatio || 1) >
												maxTicks
										) {
											if (!skipRatio) {
												skipRatio = 1;
								...
								helpers.each(me.ticks, function (label, index) {
									...
									if (isHorizontal) {
										...
										var yLineValue =
											me.getPixelForTick(index); // xvalues for grid lines
										yLineValue +=
								...
								linear: function (
									...
									if (
										...
										spacing = helpers.niceNum(
											niceRange /
												(generationOptions.maxTicks -
													1),
											true
										);
									}
									var niceMin =
										Math.floor(dataRange.min / spacing) *
										spacing;
									var niceMax =
										Math.ceil(dataRange.max / spacing) *
										spacing;
								...
								logarithmic: function (
									...
									var tickVal = getValueOrDefault(
										...
										Math.pow(
											10,
											Math.floor(
												helpers.log10(dataRange.min)
											)
										)
									);

									var endExp = Math.floor(
										helpers.log10(dataRange.max)
									);
							...
							beforeUpdate: function (chartInstance) {
								...
								if (titleOpts) {
									...
									if (chartInstance.titleBlock) {
										chartInstance.titleBlock.options =
											titleOpts;
									} else {
										createNewTitleBlockAndAttach(
											chartInstance,
						...
						Chart.Tooltip = Chart.Element.extend({
							...
							getTitle: function () {
								...
								var beforeTitle = callbacks.beforeTitle.apply(
									...
									title = callbacks.title.apply(
										me,
										arguments
									),
									afterTitle = callbacks.afterTitle.apply(
										me,
										arguments
									);
							...
							handleEvent: function (e) {
								...
								if (e.type === "mouseout") {
									...
									me._active =
										me._chartInstance.getElementsAtEventForMode(
											e,
											options.mode,
											options
										);
							...
							inRange: function (chartX, chartY) {
								...
								if (vm) {
									var pointRelativePosition =
										...
										distance =
											pointRelativePosition.distance;
						...
						return {
							...
							addEventListener: function (chart, type, listener) {
								...
								var stub =
									...
									(listener._chartjs = {});
								var proxies =
									stub.proxies || (stub.proxies = {});
								var proxy = (proxies[chart.id + "_" + type] =
									function (event) {
										listener(
											fromNativeEvent(event, chart.chart)
										);
									});
							...
							getPixelForValue: function (
								...
								var offsetAmt = Math.max(
									me.maxIndex +
										1 -
										me.minIndex -
										(me.options.gridLines.offsetGridLines
											? 0
											: 1),
									1
								);
					...
					module.exports = function (Chart) {
						...
						var LogarithmicScale = Chart.Scale.extend({
							determineDataLimits: function () {
								...
								me.min = getValueOrDefault(
									tickOpts.min,
									me.min
								);
								me.max = getValueOrDefault(
									tickOpts.max,
									me.max
								);
							...
							buildTicks: function () {
								...
								var ticks = (me.ticks =
									Chart.Ticks.generators.logarithmic(
										generationOptions,
										me
									));
							...
							getPixelForValue: function (value) {
								...
								if (me.isHorizontal()) {
									range =
										helpers.log10(me.end) -
										helpers.log10(start); // todo: if start === 0
									if (newVal === 0) {
										pixel = me.left;
									} else {
					...
					module.exports = function (Chart) {
						...
						var TimeScale = Chart.Scale.extend({
							...
							getLabelMoment: function (datasetIndex, index) {
								...
								if (
									typeof this.labelMoments[datasetIndex] !==
									"undefined"
								) {
									return this.labelMoments[datasetIndex][
										index
									];
								}
							...
							getLabelDiff: function (datasetIndex, index) {
								...
								if (
									typeof me.labelDiffs[datasetIndex] !==
									"undefined"
								) {
							...
							determineDataLimits: function () {
								...
								if (
										...
										function (label) {
											...
											if (labelMoment.isValid()) {
												if (me.options.time.round) {
													labelMoment.startOf(
														me.options.time.round
													);
												}
												scaleLabelMoments.push(
													labelMoment
												);
											}
										},
									...
									me.firstTick = moment.min.call(
										me,
										scaleLabelMoments
									);
									me.lastTick = moment.max.call(
										me,
										scaleLabelMoments
									);
								} else {
								...
								if (me.options.time.min) {
									me.firstTick = me.parseTime(
										me.options.time.min
									);
								}

								if (me.options.time.max) {
									me.lastTick = me.parseTime(
										me.options.time.max
									);
								}
							...
							buildTicks: function () {
								...
								if (!me.options.time.min) {
									me.firstTick = me.getMomentStartOf(
										me.firstTick
									);
									roundedStart = me.firstTick;
								} else {
									roundedStart = me.getMomentStartOf(
										me.firstTick
									);
								}
								...
								if (!me.options.time.max) {
									var roundedEnd = me.getMomentStartOf(
										me.lastTick
									);
									var delta = roundedEnd.diff(
										me.lastTick,
										me.tickUnit,
										true
									);
							...
							parseTime: function (label) {
								var me = this;
								if (
									typeof me.options.time.parser === "string"
								) {
									return moment(
										label,
										me.options.time.parser
									);
								}
								if (
									typeof me.options.time.parser === "function"
								) {
