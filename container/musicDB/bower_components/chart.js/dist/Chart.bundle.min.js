				...
				function (e, n, i) {
					!(function (e, a) {
						...
						function ri(t) {
							...
							switch (
								((e =
									this._days + Math.round(ai(this._months))),
								t)
							) {
								case "week":
									return e / 7 + i / 6048e5;
						...
						Z("H", ["HH", 2], 0, "hour"),
							...
							Z("hmm", 0, 0, function () {
								return (
									"" + jt.apply(this) + q(this.minutes(), 2)
								);
							}),
										...
										if (
											...
											for (
												...
												var d =
													...
													c =
														n.chart.getDatasetMeta(
															u
														);
												if (
													c.bar &&
													c.xAxisID === a.id &&
													n.chart.isDatasetVisible(
														u
													) &&
													i.stack === c.stack
												) {
						...
						(t.defaults.global.animation = {
							...
							(t.animationService = {
								...
								addAnimation: function (t, e, n, i) {
									...
									for (
										var r = 0;
										r < a.animations.length;
										++r
									)
										if (a.animations[r].chartInstance === t)
											return void (a.animations[
												r
											].animationObject = e);
									a.animations.push({
										chartInstance: t,
							...
							i.extend(t.Controller.prototype, {
								...
								resize: function (t) {
									var e = this,
										...
										o = n.canvas,
										s =
											(r.maintainAspectRatio &&
												n.aspectRatio) ||
											null,
										l = Math.floor(i.getMaximumWidth(o)),
										u = Math.floor(
											s ? l / s : i.getMaximumHeight(o)
										);
									if (
								...
								updateDatasets: function () {
									var t = this;
									if (
										a.notify(t, "beforeDatasetsUpdate") !==
										!1
									) {
										for (
											var e = 0,
								...
								drawDatasets: function (t) {
									var e = this;
									a.notify(e, "beforeDatasetsDraw", [t]) !==
										!1 &&
										(i.each(
											e.data.datasets,
											function (n, i) {
				...
				function (t, e, n) {
					...
					e.exports = function (t) {
						...
						(r.requestAnimFrame = (function () {
							...
							(r.drawRoundedRectangle = function (
								t,
								e,
								n,
								i,
						...
						t.LinearScaleBase = t.Scale.extend({
							...
							buildTicks: function () {
								...
								var o = {
									...
									s = (n.ticks = t.Ticks.generators.linear(
										o,
										n
									));
				...
				function (t, e, n) {
					...
					e.exports = function (t) {
						...
						function c(t, n, i, a) {
							var r = t.ctx;
							if (
								((r.strokeStyle = f.getValueAtIndexOrDefault(
									n.color,
									a - 1
								)),
								(r.lineWidth = f.getValueAtIndexOrDefault(
									n.lineWidth,
									a - 1
								)),
								t.options.lineArc)
								...
								r = t.Scale.extend({
									...
									getLabelForIndex: function (t, e) {
										var n = this,
											i =
												n.chart.data.labels &&
												t < n.chart.data.labels.length
													? n.chart.data.labels[t]
													: "",
											a =
												n.chart.data.datasets[e].data[
													t
												];
										return (
											null !== a &&
