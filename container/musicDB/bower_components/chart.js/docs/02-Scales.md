...
| maxRotation     | Number   | 90                                                                        | Maximum rotation for tick labels when rotating to condense labels. Note: Rotation doesn't occur until necessary. _Note: Only applicable to horizontal scales._                                                                       |
