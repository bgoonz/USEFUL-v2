...
app.controller("PageCtrl", [
  ...
  function ($scope, $location, $http) {
          ...
          columns: [
            ...
            "first_release_date_day",
            {
              ...
              columns: [
                "name",
                "artist_credit",
                { name: "artist", columns: ["id", "name"] },
              ],
            },
          ],
          order_by: [
            { column: "first_release_date_year", type: "desc", nulls: "last" },
    ...
    $scope.getDate = function (release) {
      return new Date(
        release.first_release_date_year,
        release.first_release_date_month,
        release.first_release_date_day
      );
    };
        ...
        function success(res) {
          ...
          res.data.forEach(function (r) {
            if (formattedData[r.tag]) {
              formattedData[r.tag].data.push({
                x: r.first_release_date_year,
                y: r.count,
              });
            } else {
              formattedData[r.tag] = {
                label: r.tag_details.name,
                data: [
                  {
                    x: r.first_release_date_year,
                    y: r.count,
