        ...
        <head>
          ...
          <script
            dangerouslySetInnerHTML={{
              __html: `window.__data=${serialize(initialStore)};`,
            }}
            charSet="UTF-8"
          />
          <script
            dangerouslySetInnerHTML={{
              __html: `window.__env={ namespace: '${process.env.NAMESPACE}', scheme: '${process.env.SCHEME}', baseDomain: '${process.env.BASE_DOMAIN}' };`,
            }}
          />
        </head>
        <body>
