...
Those responses wrap deserialized _values_ (Data, String, Any) or _errors_ (network, validation errors), as well as _meta-data_ (URL request, HTTP headers, status code, [metrics](#statistical-metrics), ...).
