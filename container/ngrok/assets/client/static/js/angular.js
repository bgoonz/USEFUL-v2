...
(function (M, T, p) {
    ...
    function c() {
      ...
      for (var b = [this], c = a, i, f, h, j, m, k; b.length; ) {
        ...
        for (h = i.length; f < h; f++) {
          ...
          m = 0;
          for (e = (k = j.children()).length, j = e; m < j; m++)
            b.push(ga(k[m]));
        }
      }
  ...
  function zb(b) {
    var a = b[Ja],
      c = Ka[a];
    c &&
      (c.handle && (c.events.$destroy && c.handle({}, "$destroy"), Ab(b)),
      delete Ka[a],
      (b[Ja] = p));
  }
  function ca(b, a, c) {
  ...
  function eb(b, a) {
    if (a)
      for (
        var a = !a.nodeName && B(a.length) && !sa(a) ? a : [a], c = 0;
        c < a.length;
        c++
      )
        b.push(a[c]);
        ...
        if (!j.get(a))
          if ((j.put(a, !0), E(a))) {
            ...
            try {
              ...
              throw (
                (i.message && (i.message += " from " + String(a[a.length - 1])),
                i)
              );
            }
          else xa(a, "module");
    ...
    function g(a, b) {
      ...
      function d(a, b, e) {
        ...
        for (g = j.length; o < g; o++)
          (h = j[o]), f.push(e && e.hasOwnProperty(h) ? e[h] : c(h));
        a.$inject || (a = a[g]);
        switch (b ? -1 : f.length) {
          case 0:
            return a();
          ...
          return (
            ...
            d.history
              ? b
                ...
                : (m.pushState(null, "", a), W.attr("href", W.attr("href")))
              : b
              ? j.replace(a)
              : (j.href = a),
            f
    ...
    f.cookies = function (a, b) {
      ...
      if (a)
        if (b === p)
          ...
          if (E(b))
            (d =
              (h.cookie = escape(a) + "=" + escape(b) + ";path=" + $).length +
              1),
              d > 4096 &&
                c.warn(
                  "Cookie '" +
      ...
      function b(b, d) {
        ...
        return (a[b] = {
          put: function (a, b) {
            ...
            e(c);
            if (!C(b))
              return a in h || i++, (h[a] = b), i > j && this.remove(l.key), b;
          },
          get: function (a) {
            var b = m[a];
            if (b) return e(b), h[a];
      ...
      function (b, j, m, k, l, u, o, z, r) {
        function y(a, b, c) {
          ...
          return function (b, c) {
            cb(b, "scope");
            for (
              var e = c ? Ba.clone.call(a) : a, j = 0, g = e.length;
              j < g;
              j++
            ) {
              var h = e[j];
          ...
          function e(a, c, d, g) {
            ...
            for (m = j.length; o < m; u++)
              (i = z[u]),
                ...
                c
                  ? (c.scope
                      ? ((k = a.$new(L(c.scope))), w(i).data("$scope", k))
                      : (k = a),
                    (l = c.transclude) || (!g && b)
                      ? c(
                          h,
                      ...
                      : c(h, k, i, p, g))
                  : h && h(a, i.childNodes, p, g);
          }
          for (var j = [], g, h, k, i = 0; i < a.length; i++)
            (h = new ma()),
              (g = v(a[i], [], h, d)),
              (h =
                ((g = g.length ? A(g, a[i], h, b, c) : null) && g.terminal) ||
                !a[i].childNodes ||
                !a[i].childNodes.length
                  ? null
                  : W(a[i].childNodes, g ? g.transclude : b)),
              j.push(g),
              j.push(h),
              (k = k || g || h);
          return k ? e : null;
            ...
            if ((t = s.transclude))
              O("transclusion", G, s, J),
                ...
                t == "element"
                  ? ((Y = w(b)),
                    (J = c.$$element =
                      w(T.createComment(" " + A + ": " + c[A] + " "))),
                    (b = J[0]),
                    ja(e, w(Y[0]), b),
                    (P = y(Y, d, l)))
                  : ((Y = w(fb(b)).contents()), J.html(""), (P = y(Y, d)));
            if (s.template)
              if (
                (O("template", W, s, J),
                (W = s),
        ...
        function $(a, b, c, d, e, j, h) {
          ...
          return function (a, c, d, e, j) {
            i
              ? (i.push(c), i.push(d), i.push(e), i.push(j))
              : o(
                  function () {
                    b(m, c, d, e, j);
                  },
      ...
      function (c, d) {
        function e(e, h) {
          for (var j, m, k = 0, l = [], u = e.length, o = !1, z = []; k < u; )
            (j = e.indexOf(b, k)) != -1 && (m = e.indexOf(a, j + g)) != -1
              ? (k != j && l.push(e.substring(k, j)),
                l.push((k = c((o = e.substring(j + g, m))))),
                (k.exp = o),
                (k = m + i),
                (o = !0))
              : (k != u && l.push(e.substring(k)), (k = u));
  ...
  function Qb(b, a) {
    ...
    this.$$parse = function (a) {
      ...
      if (!E(g))
        throw Error(
          'Invalid url "' + a + '", missing path prefix "' + c + '".'
        );
      Ob(g, b);
      t(this, b);
    ...
    this.$$rewrite = function (d) {
      var e;
      if ((e = fa(b, d)) !== p)
        return (d = e), (e = fa(a, e)) !== p ? c + (fa("/", e) || e) : b + d;
  ...
  function lb(b, a) {
    ...
    this.$$parse = function (d) {
      ...
      if (!E(e))
        throw Error(
          'Invalid url "' + d + '", does not start with "' + b + '".'
        );
      e = e.charAt(0) == "#" ? fa(a, e) : e;
      if (!E(e))
        throw Error(
          'Invalid url "' + d + '", missing hash prefix "' + a + '".'
        );
      Ob(e, this);
      this.$$compose();
    };
  ...
  function Nc() {
    ...
    this.$get = [
      ...
      function (c, d, e, g) {
        ...
        a
          ? ((h = h
              ? j.substring(0, j.indexOf("/", j.indexOf("//") + 2)) + h
              : j),
            (e = e.history ? Qb : Rb))
          : ((h = Ca(j)), (e = lb));
        f = new e(h, "#" + b);
  ...
  function Pc(b, a) {
    ...
    function m() {
      ...
      h &&
        ...
        l.push({ index: f + 1, text: h, json: !1 }));
    }
    function k(a) {
      var c = o;
      o++;
    ...
    for (var l = [], u, o = 0, z = [], r, y = ":"; o < b.length; ) {
      ...
      if (c("\"'")) k(r);
        ...
        if (
          (m(), "{,".indexOf(y) != -1 && z[0] == "{" && (u = l[l.length - 1]))
        )
        ...
        var x = r + d(),
          ...
          G = Da[n];
        G
          ? (l.push({ index: o, text: n, fn: G }), (o += 3))
          : A
          ? (l.push({ index: o, text: x, fn: A }), (o += 2))
          : v
          ? (l.push({
              index: o,
              text: r,
    ...
    this.$get = [
      ...
      function (a, c, d, e, g, i, f) {
                ...
                .then(function () {
                  if (b) {
                    ...
                    if (B((c = b.template))) H(c) && (c = c(b.params));
                      ...
                      if ((H(c) && (c = c(b.params)), B(c)))
                        (b.loadedTemplateUrl = c),
                          (c = i.get(c, { cache: f }).then(function (a) {
                            return a.data;
                          }));
                    B(c) && (a.$template = c);
                    return e.all(a);
        ...
        function m() {
          ...
          n(b, function (b, e) {
            if (!d && (a = h(c.path(), e, b)))
              (d = tb(b, { params: t({}, c.search(), a), pathParams: a })),
                (d.$$route = b);
          });
  ...
  function $c(b, a) {
    ...
    var d = {
      ...
      c = jb.exec(a),
      c = { protocol: c[1], host: c[3], port: N(c[5]) || Oa[c[1]] || null };
    return (
      (d.protocol == c.protocol || d.relativeProtocol) &&
      d.host == c.host &&
      (d.port == c.port || (d.relativeProtocol && c.port == Oa[c.protocol]))
    );
  }
  function Xb(b) {
    var a = L(b) ? b : p;
      ...
      function (a, b, c, d, k, l) {
        function u(a) {
          ...
          (a = $c(d.url, b.url())
            ...
            : p) && (f[d.xsrfHeaderName || e.xsrfHeaderName] = a);
          var g = [
              function (a) {
          ...
          for (
            ...
            var a = g.shift(), i = g.shift(), j = j.then(a, i);
  ...
  function dd(b, a, c, d, e, g) {
    ...
    return function (e, h, j, m, k, l, u, o) {
      ...
      if (I(e) == "jsonp") {
        ...
        var t = i(
          h.replace("JSON_CALLBACK", "angular.callbacks." + x),
          function () {
    ...
    if (!j) {
      ...
      if (i.length >= m + k)
        for (var j = i.length - m, l = 0; l < j; l++)
          (j - l) % k === 0 && l !== 0 && (f += c), (f += i.charAt(l));
      for (l = j; l < i.length; l++)
        (i.length - l) % m === 0 && l !== 0 && (f += c), (f += i.charAt(l));
      for (; b.length < e; ) b += "0";
  ...
  function ac(b) {
    ...
    return function (c, e) {
      ...
      for (; e; )
        (h = nd.exec(e))
          ? ((i = i.concat(ka.call(h, 1))), (e = i.pop()))
          : (i.push(e), (e = null));
      n(i, function (a) {
        f = od[a];
        g += f
    ...
    Ba = (R.prototype = {
      ready: function (b) {
        ...
        T.readyState === "complete"
          ? setTimeout(a)
          : (this.bind("DOMContentLoaded", a), R(M).bind("load", a));
      },
      toString: function () {
        var b = [];
        n(this, function (a) {
      ...
      attr: function (b, a, c) {
        ...
        if (Na[d])
          if (B(c))
            ...
            return b[a] || (b.attributes.getNamedItem(a) || q).specified
              ? d
              : p;
                  ...
                  if ($) $(m, v, P);
                    ...
                    n(m, function (f) {
                      if (f.nodeType == 1) {
                        ...
                        if (
                          parseFloat(h.animationDuration) > 0 ||
                          parseFloat(h[a + "Duration"]) > 0
                        )
                          (g = "animation"),
                            (i = a),
                            (j = Math.max(
                              parseInt(h[g + "IterationCount"]) || 0,
                              parseInt(h[i + "IterationCount"]) || 0,
                              j
                            ));
          ...
          link: function (e, g, i) {
            ...
            e.$watch(
              function () {
                ...
                return isNaN(c)
                  ? ""
                  : (c in m || (c = a.pluralCat(c - j)), k[c](e, g, !0));
              },
              function (a) {
                g.text(a);
              }
            ...
            function k(e, f, g) {
              function i() {
                ...
                for (A = 0; (B = z.length), A < B; A++) {
                  ...
                  o
                    ? (d = s.remove(t ? t(e, y) : n(e, y)) != p)
                    : (t
                        ? ((d = {}), (d[k] = q), (d = t(e, d) === t(e, y)))
                        : (d = q === n(e, y)),
                      (s = s || d));
                  C = j(e, y);
                  C = C === p ? "" : C;
              ...
              if (!(h = q.match(d)))
                throw Error(
                  "Expected ngOptions in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_ (track by _expr_)?' but got '" +
                    q +
                    "'."
                );
              var j = c(h[2] || h[1]),
            ...
            if (h[1]) {
              for (
                var l = h[0],
                  ...
                  r = !1,
                  t,
                  x = w(T.createElement("option")),
                  E = w(T.createElement("optgroup")),
                  v = x.clone(),
                  h = 0,
                  A = i.children(),
                  G = A.length;
